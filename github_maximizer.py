...
def main():
    ...
    parser.add_argument(
        '-n', '--repo-name', default='ocean', metavar='REPO_NAME',
        dest='repo_name',
        help='Specify the name of the repository to be created.')
    parser.add_argument(
        '--repo-path', default=os.getcwd(), metavar='REPO_PATH',
        dest='repo_path',
    ...
    parser.add_argument(
        '-u', '--username', required=True, metavar='USERNAME', dest='username',
        help='Your Github username')
    parser.add_argument(
        '-p', '--password', required=True, metavar='PASSWORD', dest='password',
